...
int main(int argc, char* argv[])
{
	...
	std::string vertexShaderName   = "../../../Neptune/Engine/Multiplatform/Core/Shaders/Vertex/RawDisplay.vert";//FunWithUniforms.vert";
	...
	spawner.createColorData({0.5f, 0.2f, 0.3f, 1.0f});
	...
	while(true)
	{
		...
		//view->getRenderer().updateUniform("Time", );
		view->update();
